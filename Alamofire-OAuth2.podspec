...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/Alamofire-OAuth2'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Fabio Borella' => 'info@pencildrummer.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/Alamofire-OAuth2.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'Alamofire-OAuth2' => ['Alamofire-OAuth2/Assets/*.png']
  # }
